...
function App() {
  ...
  //   const [specState, setSpecState] = useState(specials);
    ...
    const addNumber = (num) => {
        setDisplayAnswer(displayAnswer => displayAnswer + num)
    };
    const addOperator = (oper) => {
        (oper === '=') ? setDisplayAnswer(displayAnswer => eval(displayAnswer)) :setDisplayAnswer(displayAnswer => displayAnswer + " " + oper + " ")
    };
